    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-6">
      <div className="w-full max-w-3xl p-8 bg-white shadow-xl rounded-2xl">
        ...
        <Logo className="w-20 h-20"/>
          ...
          <PrimaryButton name="Cidadão Comum" addClassName="w-full md:w-26 py-3 text-sm font-medium h-10 flex items-center justify-center" onClick={() => { navigate('/personal')}} />
           <PrimaryButton name="Empresa" addClassName="w-full md:w-26 py-3 text-sm font-medium opacity-70 h-10 flex items-center justify-center" onClick={() => { navigate('/enterprise')}} />
         </div>
