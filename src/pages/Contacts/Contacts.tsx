...
function Contacts() {
  return (
    <div className={styles.containerContacts}>
      ...
      <img className={styles.image} src={image} alt="someoneonphone" /> <br /> <br /> <br />
      <div className={styles.cards}>
        <div className={styles.card1}>
          <FiPhone color='green' size={70}></FiPhone>
          <h4>Telefone</h4>
          <p>(+244) 934156335</p>
          <p>(+244) 946121098</p>
        </div>
        ...
        <div className={styles.card2}>
          <MdOutlineEmail color='green' size={70}></MdOutlineEmail>
          <h4>Email</h4>
      ...
      <MdCopyright size={30} color='#fff'></MdCopyright>
